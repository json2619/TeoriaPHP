...
<body>
    ...
    <form name='f1' method='post' action='<?php echo $_SERVER['PHP_SELF']; ?>' enctype='multipart/form-data'>
        ...
        <fieldset>
            <legend><b>Mostrar productos según tienda y familia</b></legend>
    ...
    if (isset($_POST['Mostrar'])) {
        ...
        echo "<table border='2'>";
        echo "<th>Cod</th><th>Nombre</th><th>Descripcion</th><th>PVP</th><th>Familia</th><th>Unidades</th>";
