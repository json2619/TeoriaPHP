...
<body>
    ...
    <form name='f1' method='post' action='<?php echo $_SERVER['PHP_SELF']; ?>'>
        ...
        <fieldset>
            <legend>Paginación de Alumnos</legend>
            ...
            <label for='Apellido1'>Apellido1 </label><input type='text' name='Apellido1'
                value='<?php echo $fila['Apellido1']; ?>'><br>
            ...
            <a href='<?php echo $_SERVER['PHP_SELF'] . "?NIF=$primero"; ?>'>
                << </a>&nbsp
                    <a href='<?php echo $_SERVER['PHP_SELF'] . "?NIF=$ant"; ?>'>
                        < </a>&nbsp
