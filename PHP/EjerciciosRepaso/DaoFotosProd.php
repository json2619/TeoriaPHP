...
require_once 'FotosProd.php';

class DaoFotosProd extends DB
{
    public $fotosProd = array();  //Array de objetos con el resultado de las consultas
    ...
    {
        $consulta = "insert into fotosprodb values(:IdProd,:IdFoto,:Foto)";

        $param = array();

        $param[":IdProd"] = $fotoP->__get("IdProd");
